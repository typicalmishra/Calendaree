...
let renderCalendar = () => {
    ...
    for (let i = 1; i <= lastDay; i++) {
        ...
        console.log(idForViewingSchedule)
        if (
            i === new Date().getDate() &&
            ...
            if (found['found'] == true) {
                ...
                days +=
                    `<a  class="today clicked all-dates" href='/viewSchedule/${urlForViewingSchedule}' id=${idForViewingSchedule}>
                    <span>${i}</span>
                    ` + a + `
                    <div class="total-number-of-events-on-the-date">${dateList[index].count}</div>
                </a>`;
            } else {
                days += `<a  class="today clicked all-dates" href='/viewSchedule/${urlForViewingSchedule}' id=${idForViewingSchedule}>
                <span>${i}</span>
            </a>`;
            }
        } else {
            ...
            if (found['found'] == true) {
                ...
                days +=
                    `<a  class="other-Dates all-dates" href='/viewSchedule/${urlForViewingSchedule}' id=${idForViewingSchedule}>
                    <span>${i}</span>
                    ` + a + `
                    <div class="total-number-of-events-on-the-date">${dateList[index].count}</div>
                </a>`;
            } else {
                days += `<a  class="other-Dates all-dates" href='/viewSchedule/${urlForViewingSchedule}' id=${idForViewingSchedule}>
                <span>${i}</span>
            </a>`;
            }
        }
