...
let renderCalendar = () => {
    ...
    document.querySelector(".date p").innerHTML = `${monthInput} ${yearInput}`;
    let days = "";
    for (let x = firstDayIndex; x > 0; x--) {
        days += `<a class="prev-date"><span> ${prevLastDay - x + 1} </sapn></a>`;
    }
    for (let i = 1; i <= lastDay; i++) {
        ...
        if (
            ...
            days +=
                `<a  class="today clicked all-dates" href='/viewAppointment/${urlForViewingSchedule}'>
                    <span>${i}</span>
                    <div class="events-inside-date-box-in-calendar-itself">3 Appointments...</div>
                    <div class="total-number-of-events-on-the-date">3</div>
                </a>`;
        } else {
            days +=
                `<a class="other-Dates all-dates"  href='/viewAppointment/${urlForViewingSchedule}'>
                    <span>${i}</span>
                    <div class="events-inside-date-box-in-calendar-itself">3 Appointments...</div>
                    <div class="total-number-of-events-on-the-date">3</div>
                </a>`;
...
console.log(eventNameInsideDate[1])
if(eventNameInsideDate[0].innerText.length>20){
    console.log("greater than 20")
    eventNameInsideDate[0].innerText=eventNameInsideDate[0].innerText+" ..."
}
else{
    console.log("not greater than 20")
}
if(eventNameInsideDate[1].innerText.length>20){
    console.log("greater than 20")
    eventNameInsideDate[1].innerText=`${eventNameInsideDate[1].innerText} ..."`
}
else{
    console.log("not greater than 20")
}
