...
const renderCalendar = () => {
    ...
    // console.log(prevLastDay + " previus last day")
    
    const firstDayIndex = date.getDay();
    // console.log(firstDayIndex + " first day index")
    ...
    // console.log(lastDayIndex + " last day index")     
    ...
    if (
        ...
        days += `<div onclick="showContactFormFunctionInBookAppointment(this)"  class="today clicked all-dates">${i}</div>`;
    } else {
        days += `<div onclick="showContactFormFunctionInBookAppointment(this)"  class="other-Dates all-dates" >${i}</div>`;
    }
    }
    if(nextDays>=1){
...
function showContactFormFunctionInBookAppointment(x) {
  ...
  inputDateInFloatingForm.value=("2020" + "-"+ monthInNumber+ "-"+ x.innerText )
}
